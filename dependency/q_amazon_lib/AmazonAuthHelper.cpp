...
AmazonAuthHelper::AmazonAuthHelper(const QString& accessKey, const QString& secret, const QString& bucketName, const QString& amzAddr)
: m_AWSAccessKeyId(accessKey)
, m_AWSSecretAccessKey(secret)
, m_bucketName(bucketName)
, m_amazonAddress(amzAddr)
{
}
